...
% Creating Trajectory Dataset    
    traj=zeros(length(X_traj_in(:,1)),2*length(t_traj)); 
    traj(:,1:2:end)=X_traj_in; traj(:,2:2:end)=Y_traj_in;
%tData=tData/fps;
%ave experimental_PIV_data.mat tData ugrid vgrid gridX gridY
clear Maxx Maxy Minx Miny F_u F_v Int IntX IntY tgrid i X_traj X_traj_in Y_traj Y_traj_in k t_traj dt_traj dx EX Ind_rng ugrid vgrid xData yData Xgrid Ygrid uData vData
